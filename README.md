...
```
$ java -jar target/tabula-1.0.5.6-jar-with-dependencies.jar --help
...
It also includes a debugging tool, run `java -cp ./target/tabula-1.0.5.6-jar-with-dependencies.jar technology.tabula.debug.Debug -h` for the available options.
